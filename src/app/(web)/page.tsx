            ...
            <section className="pt-6 pb-8 space-y-6 md:pb-12 md:pt-10 lg:py-32">
                <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
                    ...
                    <h1 className="text-3xl font-heading sm:text-5xl md:text-6xl lg:text-7xl">
                        Explore Innovation with Kodecs Technology
                    </h1>
                    <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
                        Kodecs Technology - Empowering Success Through
            ...
            >
                <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
                    ...
                    <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                        Explore the power of our software solutions designed to
                        elevate your business. From seamless ERP to cutting-edge
                        RFID systems, each product is a catalyst for efficiency
                        and innovation.
                    </p>
                </div>
                <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
                    <div className="relative p-2 overflow-hidden border rounded-lg bg-background">
                        <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                            ...
                            <div className="space-y-2">
                                <h3 className="font-bold">Buisness ERP</h3>
                                <p className="text-sm text-muted-foreground">
                                    Boost efficiency effortlessly with our
                                    cutting-edge Business ERP solutions.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="relative p-2 overflow-hidden border rounded-lg bg-background">
                        <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                            ...
                            <div className="space-y-2">
                                <h3 className="font-bold">Billing Software</h3>
                                <p className="text-sm text-muted-foreground">
                                    Efficient invoicing, Elevate your business
                    ...
                    <div className="relative p-2 overflow-hidden border rounded-lg bg-background">
                        <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                            ...
                            <div className="space-y-2">
                                <h3 className="font-bold">ID Card Maker</h3>
                                <p className="text-sm text-muted-foreground">
                                    Instant ID Card Creation, Transforming Hours
                    ...
                    <div className="relative p-2 overflow-hidden border rounded-lg bg-background">
                        <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                            ...
                            <div className="space-y-2">
                                <h3 className="font-bold">RFID Systems</h3>
                                <p className="text-sm text-muted-foreground">
                                    Effortless Tracking and Attendance, Elevate
                                    Efficiency with Our RFID System
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="relative p-2 overflow-hidden border rounded-lg bg-background">
                        <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Elevate networking with our Digital Visiting
                                    Card Maker. Create a lasting impression
                                    effortlessly.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="relative p-2 overflow-hidden border rounded-lg bg-background">
                        <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                            ...
                            <div className="space-y-2">
                                <h3 className="font-bold">
                                    ID Data Collection Portal
                                </h3>
                                <p className="text-sm text-muted-foreground">
                                    Seamless data collection from
                                    anywhere—unlock efficiency with our ID Data
                                    Collection Portal
                                </p>
                            </div>
                        </div>
                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="w-full mx-auto text-center xl:w-1/2 lg:w-3/4">
                        <svg
                            ...
                            fill="currentColor"
                            className="inline-block w-8 h-8 mb-8 text-muted"
                        ...
                        <p className="text-lg leading-relaxed">
                            At Kodecs Technology, our commitment to
                            ...
                            technology to elevate processes, empowering
